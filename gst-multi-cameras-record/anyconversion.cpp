...
AnyConversion::AnyConversion(string const& value) { value_ = value; }

AnyConversion::AnyConversion(const char* c) { value_ = c; }
...
AnyConversion::operator string() const { return value_; }

AnyConversion::operator double() const { return atof(value_.c_str()); }

AnyConversion::operator float() const { return (float)atof(value_.c_str()); }

AnyConversion::operator int() const { return atoi(value_.c_str()); }

AnyConversion::operator bool() const {
  if (value_.compare("on") == 0 || atoi(value_.c_str()) == 1) return true;
  return false;
}
